import random
def arranging_algo(work_space, worker_list):

    """
    ToDo: 
        1. absent
        2. arranging precentage
        3. pack to .exe
    """
...
def arranging(work_space, worker_list, absent_number):
    ...
    "Start Runing"
    temp_results = arranging_algo(work_space, worker_list)
    if work_space == 8:
